...
Example Usage:
bash co_assembly.sh -t 1 -M 10g -i ./spids/121231231 -r False -o output_dir/ -g ./logog.txt -A spades,megahit -S /clusterfs/jgi/scratch/science/metagen/neri/rolypoly/
Arguments:
...
alias haploflow='/clusterfs/jgi/scratch/science/metagen/neri/rolypoly/bin/Haploflow/build/haploflow'
THREADS=6
sample_dir=/clusterfs/jgi/scratch/science/metagen/neri/ynp/raw_reads/spids/1061622/
output_dir=/clusterfs/jgi/scratch/science/metagen/neri/ynp/raw_reads/spids/1061622/Assembly
rm_tmp=False
logfile=/clusterfs/jgi/scratch/science/metagen/neri/ynp/raw_reads/spids/1061592/assembly_test.log
MEMORY=20g
assembler=spades
rolypoly_dir=/clusterfs/jgi/scratch/science/metagen/neri/rolypoly/
cd /clusterfs/jgi/scratch/science/metagen/neri/ynp//raw_reads/spids/1061622/
