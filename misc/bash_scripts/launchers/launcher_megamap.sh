...
mkdir /clusterfs/jgi/scratch/science/metagen/neri/ynp/megamap/
output_dir=/clusterfs/jgi/scratch/science/metagen/neri/ynp/megamap/
...
logfile=/clusterfs/jgi/scratch/science/metagen/neri/ynp/megamap/megamap_log.txt

RVMT_contigs=/clusterfs/jgi/scratch/science/metagen/neri/rolypoly/data/RVMT/dust_maked_w10_tmp_nochimeras.fasta
NCBI_ribovirus=/clusterfs/jgi/scratch/science/metagen/neri/rolypoly/data/NCBI_ribovirus/refseq_ribovirus_genomes.fasta
Partiti22=/clusterfs/jgi/scratch/science/metagen/neri/ynp/meta/partiti_cell22.fasta
Japan_hotsprings_sequences=/clusterfs/jgi/scratch/science/metagen/neri/rolypoly/data/NCBI_ribovirus/Japan_hotsprings_sequences.fasta
...
all_spids_contigs=/clusterfs/jgi/scratch/science/metagen/neri/ynp/raw_reads/spids/cross_assembly/merged_contigs_clst_rep_seq.fasta
combined_assembly_contigs=/clusterfs/jgi/scratch/science/metagen/neri/ynp/combined_assembly/merged_contigs.fasta
...
# # ## map to RVMT + NCBI Ribovirus + seqs of interest
    ...
    # contigs4eval=/clusterfs/jgi/scratch/science/metagen/neri/rolypoly/data/RVMT/dust_maked_w10_tmp_nochimeras.fasta
    # mmseqs createdb  $contigs4eval /clusterfs/jgi/scratch/science/metagen/neri/rolypoly/data/RVMT/mmdb/RVMT_mmseqs_db2
