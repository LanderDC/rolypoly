...
bash /clusterfs/jgi/scratch/science/metagen/neri/rolypoly/rolypoly/in_reads/assembly.sh -i $spid_path -r False -o "$output_dir" -g $logfile -S $rolypoly_dir -A $assembler -t $THREADS -M $MEMORY
else
