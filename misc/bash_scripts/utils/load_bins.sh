...
# source /clusterfs/jgi/scratch/science/metagen/neri/rolypoly/rolypoly/bash_functions.sh  
# depen_dir=/clusterfs/jgi/scratch/science/metagen/neri/rolypoly/bin/ 
